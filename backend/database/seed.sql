...
-- Note: init.js will update password_hash with real bcrypt hash on db initialization
INSERT INTO `users` (`id`, `first_name`, `last_name`, `email`, `password_hash`, `phone`, `city`, `country`, `additional_info`, `profile_image`, `language`, `role`) VALUES
(1, 'Demo', 'User', 'user@example.com', '$2a$10$wK1.V/V8nL0l1N7oQ4u.1eW3xG6h.L2P8zY4n.R8T2u9V5x1y2z3a', '9876543210', 'Ahmedabad', 'India', 'Passionate explorer & adventure traveler', 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?auto=format&fit=crop&w=300&q=80', 'en', 'user'),
(2, 'Admin', 'GlobeTrotter', 'admin@globetrotter.com', '$2a$10$wK1.V/V8nL0l1N7oQ4u.1eW3xG6h.L2P8zY4n.R8T2u9V5x1y2z3a', '9998887770', 'Mumbai', 'India', 'Platform Administrator', 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&w=300&q=80', 'en', 'admin');
...
(2, 'Mumbai', 'India', 'Asia', 'The bustling City of Dreams, financial hub, iconic sea seafronts, and historic landmarks.', 3.20, 9.50, 'https://images.unsplash.com/photo-1570168007204-dfb528c6958f?auto=format&fit=crop&w=800&q=80', 19.0760, 72.8777),
...
-- 4. Insert Saved Destinations for Demo User
...
-- 5. Insert Sample Trip (Goa & Pune Coastal Adventure)
INSERT INTO `trips` (`id`, `user_id`, `name`, `description`, `start_date`, `end_date`, `cover_image`, `budget_limit`, `is_public`, `public_slug`) VALUES
(1, 1, 'Goa & Pune Coastal Getaway', 'A 6-day multi-city journey across sunny beaches of Goa and historic hill forts of Pune.', '2026-09-10', '2026-09-15', 'https://images.unsplash.com/photo-1512343879784-a960bf40e7f2?auto=format&fit=crop&w=1000&q=80', 45000.00, 1, 'goa-pune-getaway-a8f31d');
...
-- 7. Insert Scheduled Trip Activities
...
-- 8. Insert Expenses
INSERT INTO `expenses` (`id`, `trip_id`, `category`, `amount`, `description`, `expense_date`) VALUES
(1, 1, 'transport', 6500.00, 'Flight tickets to Goa and bus to Pune', '2026-09-10'),
(2, 1, 'stay', 14000.00, 'Beach resort in Calangute (2 nights) & Boutique hotel in Pune (2 nights)', '2026-09-10'),
(3, 1, 'activities', 5800.00, 'Scuba diving, cruise, and fort tickets', '2026-09-11'),
(4, 1, 'meals', 7500.00, 'Seafood thalis, beach shacks, and Pune bakeries', '2026-09-12'),
(5, 1, 'other', 1200.00, 'Souvenirs and local beach shopping', '2026-09-14');
